...
const routes: Routes = [
  ...
  {path: 'quiz-list/:filter', component: QuizListComponent},
  {path: 'edit-quiz', component: QuizEditComponent},
  {path: 'questionnaireAgnosie', component: QuestionnaireAgnosieComponent},
  {path: 'questionnaireAgnosie/:filter', component: QuestionnaireAgnosieComponent},
  {path: 'questionnaire', component: QuestionnaireComponent},
  {path: 'questionnaire/:filter', component: QuestionnaireComponent},
  {path: 'questionnaireAlzheimer', component: QuestionnaireAlzheimerComponent},
  {path: 'questionnaireAlzheimer/:filter', component: QuestionnaireAlzheimerComponent},
  {path: 'questionnaireAVC', component: QuestionnaireAVCComponent},
  {path: 'questionnaireAVC/:filter', component: QuestionnaireAVCComponent},
  {path: 'anwser', component: AnswerComponent},
  {path: 'patient-list', component: PatientListComponent},
  {path: 'patient-form', component: PatientFormComponent},
  {path: 'page-patient', component: PagePatientComponent},
  {path: 'page-patient/:filter', component: PagePatientComponent},
